...
```{r}
summary(gaps_df$vol_change)
hist(gaps_df$vol_change, breaks=100, main = "Volume change distirbution after the cleanup")
...
# TODO: run some statistical analysis, produce graphs - i.e. correlations, autocorrelation, distributions, etc. - anything to show some information about gaps
